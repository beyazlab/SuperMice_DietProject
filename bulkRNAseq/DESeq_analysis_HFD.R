...
mdata$group <- paste0(mdata$diet_category,"_",mdata$duration_of_reversion_group)
design_matrix <- read.table(paste0(meta_path,"design_matrix_bulkRNAseq_HFD.txt"), header=T, sep="\t")
...
pdf(paste0(plot_path,oname,"_DE_heatmap_top_genes_highlighted.pdf"), width=15)
